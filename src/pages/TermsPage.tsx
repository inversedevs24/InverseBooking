      ...
      <div className="max-w-container mx-auto px-6">
        ...
        <div className="bg-white border border-border rounded-card-lg p-10 max-w-[900px] mx-auto mt-10">
          ...
          {[
            ...
            { h: 'Legal Entity Details', content: <ul className="pl-5 my-2"><li className="text-label text-primary mb-[6px] leading-[1.6]"><strong>Legal Name:</strong> Luxeway Ride PASSENGERS TRANSPORT – L.L.C – O.P.C</li><li className="text-label text-primary mb-[6px] leading-[1.6]"><strong>Trade License:</strong> CN-1234567</li><li className="text-label text-primary mb-[6px] leading-[1.6]"><strong>Email:</strong> {brandEmail}</li><li className="text-label text-primary mb-[6px] leading-[1.6]"><strong>Contact Number:</strong> {brandPhone}</li></ul> },
