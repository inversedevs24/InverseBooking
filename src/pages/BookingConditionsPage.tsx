      ...
      <div className="max-w-container mx-auto px-6">
        ...
        <div className="bg-white border border-border rounded-card-lg p-10 max-w-[900px] mx-auto mt-10">
          {[
            ...
            { h: 'How to Book', items: ['Luxeway Ride mobile application', 'Official website (www.luxewayride.com)', 'Provide accurate pickup/drop-off locations', 'Choose vehicle type and confirm fare'] },
